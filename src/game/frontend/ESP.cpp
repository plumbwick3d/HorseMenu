...
LOG(INFO) << "Drawing text: " << text << " with color (R: " << color.Value.x << ", G: " << color.Value.y
		<< ", B: " << color.Value.z << ", A: " << color.Value.w << ")";
...
{
// Debug: Log the color values
LOG(INFO) << "Drawing skeleton with color (R: " << color.Value.x << ", G: " << color.Value.y
		<< ", B: " << color.Value.z << ", A: " << color.Value.w << ")";
...
{
// Debug: Log the color values
LOG(INFO) << "Drawing horse skeleton with color (R: " << color.Value.x << ", G: " << color.Value.y
		<< ", B: " << color.Value.z << ", A: " << color.Value.w << ")";
...
DrawTextInfo(
	drawList, headPos, plyr.GetName(), plyr == Players::GetSelected() ? Blue : Features::_NameColorPlayers.GetState());
}
